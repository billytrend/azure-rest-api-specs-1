...
``` yaml
openapi-type: arm
tag: package-1341232412341234
```


### Tag: package-1341232412341234

These settings apply only when `--tag=package-1341232412341234` is specified on the command line.

```yaml $(tag) == 'package-1341232412341234'
input-file:
  - Microsoft.Cdn/stable/1341232412341234/cdn.json
```
### Tag: package-2017-10
