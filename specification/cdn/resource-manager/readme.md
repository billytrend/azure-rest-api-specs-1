...
openapi-type: arm
tag: package-12341234123432
```


### Tag: package-12341234123432

These settings apply only when `--tag=package-12341234123432` is specified on the command line.

```yaml $(tag) == 'package-12341234123432'
input-file:
  - Microsoft.Cdn/stable/12341234123432/cdn.json
```
### Tag: package-2019-06
