...
``` yaml
openapi-type: arm
tag: package-134123412341
```


### Tag: package-134123412341

These settings apply only when `--tag=package-134123412341` is specified on the command line.

```yaml $(tag) == 'package-134123412341'
input-file:
  - Microsoft.Cdn/stable/134123412341/cdn.json
```
### Tag: package-2019-04
