...
openapi-type: arm
tag: package-23452345
```


### Tag: package-23452345

These settings apply only when `--tag=package-23452345` is specified on the command line.

```yaml $(tag) == 'package-23452345'
input-file:
  - Microsoft.Cdn/stable/23452345/cdn.json
```
### Tag: package-2019-06
