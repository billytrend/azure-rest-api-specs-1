...
``` yaml
openapi-type: arm
tag: package-424523452345234
```


### Tag: package-424523452345234

These settings apply only when `--tag=package-424523452345234` is specified on the command line.

```yaml $(tag) == 'package-424523452345234'
input-file:
  - Microsoft.Cdn/stable/424523452345234/cdn.json
```
### Tag: package-2017-10
