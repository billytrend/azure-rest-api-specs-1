...
``` yaml
openapi-type: arm
tag: package-1341242134
```


### Tag: package-1341242134

These settings apply only when `--tag=package-1341242134` is specified on the command line.

```yaml $(tag) == 'package-1341242134'
input-file:
  - Microsoft.Cdn/stable/1341242134/cdn.json
```
### Tag: package-2017-10
