...
``` yaml
openapi-type: arm
tag: package-31431423
```


### Tag: package-31431423

These settings apply only when `--tag=package-31431423` is specified on the command line.

```yaml $(tag) == 'package-31431423'
input-file:
  - Microsoft.Cdn/stable/31431423/cdn.json
```
### Tag: package-2017-10
