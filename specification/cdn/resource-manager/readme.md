...
``` yaml
openapi-type: arm
tag: package-13412341234123
```


### Tag: package-13412341234123

These settings apply only when `--tag=package-13412341234123` is specified on the command line.

```yaml $(tag) == 'package-13412341234123'
input-file:
  - Microsoft.Cdn/stable/13412341234123/cdn.json
```
### Tag: package-2017-10
