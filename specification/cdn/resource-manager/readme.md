...
``` yaml
openapi-type: arm
tag: package-3214234123
```


### Tag: package-3214234123

These settings apply only when `--tag=package-3214234123` is specified on the command line.

```yaml $(tag) == 'package-3214234123'
input-file:
  - Microsoft.Cdn/stable/3214234123/cdn.json
```
### Tag: package-2017-10
