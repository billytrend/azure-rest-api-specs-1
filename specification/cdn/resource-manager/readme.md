...
``` yaml
openapi-type: arm
tag: package-21332134
```


### Tag: package-21332134

These settings apply only when `--tag=package-21332134` is specified on the command line.

```yaml $(tag) == 'package-21332134'
input-file:
  - Microsoft.Cdn/stable/21332134/cdn.json
```
### Tag: package-2017-10
