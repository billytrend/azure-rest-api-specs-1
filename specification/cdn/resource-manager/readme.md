...
openapi-type: arm
tag: package-34143413431311234
```


### Tag: package-34143413431311234

These settings apply only when `--tag=package-34143413431311234` is specified on the command line.

```yaml $(tag) == 'package-34143413431311234'
input-file:
  - Microsoft.Cdn/stable/34143413431311234/cdn.json
```
### Tag: package-2019-06
