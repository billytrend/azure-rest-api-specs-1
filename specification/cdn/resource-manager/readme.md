...
``` yaml
openapi-type: arm
tag: package-134123413
```


### Tag: package-134123413

These settings apply only when `--tag=package-134123413` is specified on the command line.

```yaml $(tag) == 'package-134123413'
input-file:
  - Microsoft.Cdn/stable/134123413/cdn.json
```
### Tag: package-2017-10
