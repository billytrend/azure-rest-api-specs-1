...
These settings apply only when `--tag=package-10` is specified on the command line.

```yaml $(tag) == 'package-10'
input-file:
  - Microsoft.Compute/stable/10/compute.json
  - Microsoft.Compute/stable/10/runCommands.json
```
